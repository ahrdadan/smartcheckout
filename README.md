![test](/static/logo200.svg)

# Welcome to Smartcheckout 👋

**A faster way to checkout build and share data apps.**

## What is Streamlit?

Streamlit lets you transform Python scrivts into interactive web apps in minutes, instead of weeks. Build dashboards, generate reports, or create chat apps. Once you’ve created an app, you can use our [Community Cloud platform](https://streamlit.io/cloud) to deploy, manage, and share your app.
...
![test](static/test-countdown-digital-text-02i8gj5kwdytks0y.webp)
